...
/**
 * Created by maslick on 03/02/18.
 */
 ...
 * your code performs cycle detection or not. Cycle detection is useful to detect bugs but comes with a small cost.
...
public class Threading {
     ...
     * runs without any locks being held. It's intended for the API user to run things on. Callbacks registered by your code
     * internally shouldn't normally run here, although currently there are a few exceptions.
     */
     ...
     * code is run, setting it after you started network traffic and other forms of processing
    ...
    static {
        ...
        // instantiating any objects. The policy change will take effect only on new objects
